...
def get_user_info(user_url):
    ...
    result = requests.get(url)  #不能用session
    ...
    if result.status_code == 200:            
        ...
        file_fail.write(user_url + "\t" + str(result.status_code) + "\n")
...
def get_user_info(user_url):
    ...
    try :
        ...
        file_fail.write(user_url + "\t" + str(Exception) + "\n")
"""
